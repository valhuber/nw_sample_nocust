...
@Component({
  selector: 'SampleDBVersion-home',
  templateUrl: './SampleDBVersion-home.component.html',
  styleUrls: ['./SampleDBVersion-home.component.scss']
})
export class SampleDBVersionHomeComponent implements AfterViewInit {

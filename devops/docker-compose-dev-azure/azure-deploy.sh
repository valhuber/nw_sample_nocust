...
projectname="nwsamplenocust"  # lower case, only
resourcegroup="nwsamplenocust_rg"
...
# git clone https://github.com/apilogicserver/nwsamplenocust.git
# cd nwsamplenocust
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name nwsamplenocust --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
